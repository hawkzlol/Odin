...
object ArrowsDevice : Module(
    ...
    init {
        on<BlockUpdateEvent> {
            ...
            if (old.block == Blocks.EMERALD_BLOCK && updated.block == Blocks.DYED_TERRACOTTA.blue()) {
            ...
            } else if (old.block == Blocks.DYED_TERRACOTTA.blue() && updated.block == Blocks.EMERALD_BLOCK) {
